...
namespace OnSale.Web.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(DataContext context, IBlobHelper blobHelper, IImageHelper imageHelper , ICombosHelper combosHelper, IConverterHelper converterHelper)
        {
            _context = context;
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (model.ImageFile != null)
                    {
                        ...
                        var path = await _imageHelper.UploadImageAsync(model.ImageFile, "products");
                        product.ProductImages = new List<ProductImage>
                {
                    new ProductImage { ImageId = imageId, ImageUrl = path }
                };
                    }
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (model.ImageFile != null)
                    {
                        ...
                        product.ProductImages.Add(new ProductImage { ImageId = imageId, ImageUrl = path });
                    }
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            try
            {
                var listImagees = product.ProductImages;
                _context.Products.Remove(product);
                await _context.SaveChangesAsync();

                _imageHelper.DeleteListImage(listImagees);
        ...
        public async Task<IActionResult> DeleteImage(int? id)
        {
            ...
            var pathImage = productImage.ImageUrl;
